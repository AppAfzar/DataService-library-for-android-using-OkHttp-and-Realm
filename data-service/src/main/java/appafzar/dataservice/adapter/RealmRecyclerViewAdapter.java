...
package appafzar.dataservice.adapter;
...
public abstract class RealmRecyclerViewAdapter<T extends RealmModel, S extends RecyclerView.ViewHolder>
    ...
    public T getItem(int position) {
        ...
        if (adapterData != null && position >= adapterData.size()) return null;
        //noinspection ConstantConditions
    ...
    public abstract void setPaginationPerPage(int limitPerPage);

    public abstract void setPagination(boolean pagination);
